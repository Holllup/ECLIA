...
export function routeKeyDefaultsFromConfig(config) {
...
export function canonicalizeRouteKey(routeKey, defaults) {
...
export function canonicalizeRouteKeyForConfig(routeKey, config) {
